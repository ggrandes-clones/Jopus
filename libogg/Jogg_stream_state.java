...
public final class Jogg_stream_state {
	...
	long granulepos;
	//
	public Jogg_stream_state() {
	}
	public Jogg_stream_state(final Jogg_stream_state s) {
		copyFrom( s );
	}
	public final void copyFrom(final Jogg_stream_state s) {
		body_data = s.body_data;
		body_storage = s.body_storage;
		body_fill = s.body_fill;
		body_returned = s.body_returned;
		lacing_vals = s.lacing_vals;
		granule_vals = s.granule_vals;
		lacing_storage = s.lacing_storage;
		lacing_fill = s.lacing_fill;
		lacing_packet = s.lacing_packet;
		lacing_returned = s.lacing_returned;
		header_fill = s.header_fill;
		e_o_s = s.e_o_s;
		b_o_s = s.b_o_s;
		serialno = s.serialno;
		pageno = s.pageno;
